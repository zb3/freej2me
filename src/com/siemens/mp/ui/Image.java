...
public class Image extends com.siemens.mp.misc.NativeMem {
	...
	public static void mirrorImageHorizontally(javax.microedition.lcdui.Image image) {
		BufferedImage thisImage = ((PlatformGraphics)(image.getGraphics())).getCanvas();
		BufferedImage mirrorImage = PlatformImage.transformImage(thisImage, javax.microedition.lcdui.game.Sprite.TRANS_MIRROR);
		thisImage.setData(mirrorImage.getRaster());
	}

	public static void mirrorImageVertically(javax.microedition.lcdui.Image image) {
		BufferedImage thisImage = ((PlatformGraphics)(image.getGraphics())).getCanvas();
		BufferedImage mirrorImage = PlatformImage.transformImage(thisImage, javax.microedition.lcdui.game.Sprite.TRANS_MIRROR_ROT180);
		thisImage.setData(mirrorImage.getRaster());
	}
