...
typedef /*@only@*//*@null@*/ void* (m3gMallocFunc) (M3Gsizet bytes);

typedef void    (m3gFreeFunc)   (/*@only@*//*@null@*//*@out@*/ void *ptr);

typedef M3GMemObject (m3gObjectAllocator)    (M3Gsizet bytes);
...
M3G_API void    m3gBindMemoryTarget     (M3GRenderContext context, void *pixels, M3Guint width, M3Guint height, M3GPixelFormat format, M3Guint stride, M3Gpointer userContext);
...
M3G_API M3Gpointer m3gGetUserHandle        (M3GRenderContext hCtx);
